...
export default function App() {
  const [view, setView] = useState<Workspace>('photo');
  const [pdfHome, setPdfHome] = useState(true);
  const documentView = useRef<'photo'|'pdf'>('photo');
