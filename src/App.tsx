...
import {ensureFont, ensureDocumentFonts} from './fonts';
...
type Tool = 'select' | 'text' | 'rect' | 'ellipse' | 'line' | 'brush' | 'highlight' | 'eraser' | 'marquee' | 'lasso' | 'hand' | 'clone' | 'heal';
  ...
  useEffect(() => {
    ...
    c.on('mouse:down', e => {
      ...
      if(t==='marquee'||t==='lasso'){
        ...
        if(!target||target.lockMovementX){notify('Select an unlocked layer before drawing a selection.');return;}
