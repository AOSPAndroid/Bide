...
export default function App() {
  ...
  useEffect(() => {
    const key = (e: KeyboardEvent) => {
      ...
      if(e.key==='Escape') { setRegion(null); canvas.current?.discardActiveObject(); canvas.current?.requestRenderAll(); setTool('select'); setMenu(null); }
