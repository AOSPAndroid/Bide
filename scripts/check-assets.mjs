...
const required = ['ocr/worker.min.js','ocr/lang/eng.traineddata.gz','ocr/lang/fra.traineddata.gz',...['','-simd','-lstm','-simd-lstm'].flatMap(s=>[`ocr/core/tesseract-core${s}.wasm.js`,`ocr/core/tesseract-core${s}.wasm`]),'office/runtime/soffice.js','office/runtime/soffice.wasm','office/runtime/soffice.data','office/runtime/soffice.data.js.metadata','diagrams/runtime/index.html','diagrams/runtime/js/app.min.js','diagrams/runtime/bide-build.json'];
