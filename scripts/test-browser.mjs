...
const result=spawnSync(process.execPath,['--test','tests/browser-engine.test.mjs','tests/psd.test.mjs','tests/lan.test.mjs','tests/windows-launcher.test.mjs'],{stdio:'inherit'});
