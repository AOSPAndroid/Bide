...
const result=spawnSync(process.execPath,['--test','tests/browser-engine.test.mjs','tests/psd.test.mjs','tests/lan.test.mjs','tests/windows-launcher.test.mjs','tests/editor-tools.test.mjs','tests/command-palette.test.mjs','tests/retouch.test.mjs','tests/design-layout.test.mjs','tests/server-control.test.mjs','tests/ocr.test.mjs'],{stdio:'inherit'});
