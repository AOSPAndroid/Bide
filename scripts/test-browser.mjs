...
for (const name of ['editor-tools','diagram-data','brushes','selection-mask','command-search','retouch-pixels','design-layout','render-budget']) await build({entryPoints:[`src/${name}.ts`],bundle:true,packages:'external',format:'esm',platform:'node',outfile:`tmp/${name}.mjs`});
