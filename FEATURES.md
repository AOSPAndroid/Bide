...
- Windows setup: private Node download with SHA-256 verification, source dependency installation/build, prebuilt package launch, server reuse and paths containing spaces.
